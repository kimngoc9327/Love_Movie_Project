...
import { AUTH_TOKEN, BASE_URL, API_KEY } from "../constants/constants";
...
const getMovieDiscover = (genreId) => async (dispatch) => {
  try {
    const response = await axios.get(
      `${BASE_URL}/discover/movie?api_key=1a6043d947b8611272f1b9a41ed990bd`,
      {
        headers: {
          Authorization: `Bearer ${AUTH_TOKEN}`,
        },
