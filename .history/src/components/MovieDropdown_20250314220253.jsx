  ...
  return (
    <div className="relative">
      <Menu>
        ...
        <MenuItems className="grid grid-cols-3 gap-4 absolute left-0 mt-2 w-150 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          {genre.map((genre) => (
            <MenuItem
              key={genre.id}
              as="div"
