          ...
          <div className="flex flex-col space-y-4 text-white text-left ">
            ...
            <div className="flex space-x-3">
              <div className="relative group">
                <i className="ri-file-list-line text-white text-sm bg-[#021E34] py-3 px-3.5 rounded-[50%] cursor-pointer"></i>
                <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-max bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                  Playlist
                </span>
              </div>

              <div className="relative group">
                <i className="ri-heart-3-fill text-white text-sm bg-[#021E34] py-3 px-3.5 rounded-[50%] cursor-pointer"></i>
                <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-max bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                  Favorite
                </span>
              </div>
              ...
              <div className="relative group">
                <i className="ri-bookmark-fill text-white text-sm bg-[#021E34] py-3 px-3.5 rounded-[50%] cursor-pointer"></i>
                <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-max bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                  Bookmark
                </span>
              </div>
