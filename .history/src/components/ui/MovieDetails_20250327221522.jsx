        ...
        <div className="flex relative space-x-20 z-10  mx-20 w-full ">
          ...
          <div className="flex flex-col space-y-4 text-white text-left ">
            ...
            <div className="flex space-x-3">
              <i className="ri-file-list-line text-white text-sm bg-[#021E34] p-2.5"></i>
              <i className="ri-heart-3-fill text-white text-sm bg-[#021E34] p-2.5"></i>
              <i className="ri-bookmark-fill text-white text-sm bg-[#021E34] p-2.5"></i>
