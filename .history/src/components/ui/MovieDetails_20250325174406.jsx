...
function MovieDetails({ movie }) {
  return (
    <div
      className="relative flex items-center w-full h-[500px] mt-20 bg-cover bg-center bg-gradient-to-br from-gray-800 to-gray-800/85 min-h-screen "
      style={{
        backgroundImage: `url(${BACKDROP_PATH + movie?.backdrop_path})`,
        height: "500px",
      }}
    >
      <div className="absolute inset-0 backdrop-brightness-50 h-125"></div>
