  ...
  return (
    <div className="flex fixed z-50 w-screen top-0 items-center text-white p-[24px] h-[64px] bg-black">
      <div className="flex space-x-8 items-center ml-8">
        ...
        <div
          className={`flex space-x-8 items-center max-lg:absolute max-lg:flex max-lg:items-center max-lg:flex-col  max-lg:left-0 max-lg:w-30 max-lg:p-4 max-lg:transition-all max-lg:${
