...
const Header = () => {
  ...
  return (
    <div className="fixed z-50 w-full top-0 bg-black text-white p-4 flex items-center justify-between h-16">
      {/* Logo & Menu Button */}
      <div className="flex lg:justify-between space-x-8 items-center ml-8 ">
