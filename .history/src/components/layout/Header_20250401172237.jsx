...
const Header = () => {
  ...
  return (
    <div className="flex fixed z-50 w-screen top-0 items-center text-white p-[24px] h-[64px] bg-black max-lg:jutify-between max-lg:px-0">
      <div className="flex space-x-8  items-center ml-8 max-lg:jutify-between max-lg:w-full">
        ...
        <div className="max-lg:hidden flex space-x-8 items-center">
          <Link to="/">
